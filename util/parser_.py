...
def get_argparse():
    ...
    parser.add_argument('--category', dest='category', type=str, help='One of 15 sub-datasets of Mvtec AD or 5 sub-datasets of Mvtec LOCO')
    ...
    print(f"category : {magenta(args.category)}")
